        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clients_UserProfils_ProfilId",
                        column: x => x.ProfilId,
                        principalTable: "UserProfils",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_UserClients_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserEmployees_Employees_ProfilId",
                        column: x => x.ProfilId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserEmployees_ProfilId",
                table: "UserEmployees",
                column: "ProfilId");
        }
